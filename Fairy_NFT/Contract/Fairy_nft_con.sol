...
contract KIP17Kbirdz is KIP17, KIP17Enumerable, KIP17Metadata, MinterRole {
    ...
    // 토큰 URI 변경하는 함수 현재 리빌 상태를 체크하여 리빌을 진행하게 되어있음 
    ...
    function withdraw() external onlyMinter{
      ...
      // =============================================================================
      //x3e944Ca8B08a0a0D3245B05ABF01586B9142f52C.transfer(address(this).balance * 5 / 100);
      // =============================================================================
...
// 마지막 모든 컨트랙트 연결 
contract KIP17KFairyToken is KIP17Full, KIP17Mintable, KIP17MetadataMintable, KIP17Burnable, KIP17Pausable {
